...
(function($){
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var stepHtml = "<li class='ystep-step ystep-step-undone' data-container='body' data-toggle='popover' data-placement='"+placement+"' data-title='' data-content='' data-trigger='hover'>"+
                     "</li>";
      //决策器
      var logic = {
        size: {
