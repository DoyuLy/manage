...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/promotion/sulist.css" />
...
<body>
  ...
  <div id="sitebody">
    <div id="mbox_left">
      <ul id="ml_menu">
        ...
        <li class="mlm_select"><a href="/promotion/marketBusiness">市场商家广告</a></li>
      ...
      <c:choose>
        ...
        <c:otherwise>
          <table class="table" style="z-index: 1;">
            <tr>
              <th colspan="2" style="height: 50px; background: #FF8E1C; color: white;">Go2.CN市场商家页广告</th>
            </tr>
            <tr>
              <th width="80">位置说明</th>
              <td style="text-align: left; line-height: 150%; padding: 10px 20px 10px 20px; font-size: 12px;">
                <p style="text-indent: 24px;">市场商家页面广告位于市场商家列表页右侧，共有10个位置，滚动显示。</p>
              </td>
            </tr>
            <tr>
              <th width="80">推广效果</th>
            ...
            <tr>
              <th width="80">订购价格</th>
              <td style="text-align: left; line-height: 150%; padding: 10px 20px 10px 20px; font-size: 12px;"><span style="color: red">600元/7天</span>
              </td>
            </tr>
            <tr>
              <th width="80">订购规则</th>
                ...
                <div style="margin: 0px; height: 120px; padding: 0px; font-size: 16px; font-family: 微软雅黑;">
                  ...
                  <script>
									...
									function countdownComplete() {
										window.location.href = "/manage/promotion/marketBusiness";
									}
								</script>
                </div>
              </div>
 ...
 %> <fmt:formatDate var="endTimeStr" value="${endTimeValue}" pattern="yyyy-MM-dd" /> ${endTimeStr}</td>
                        ...
                        <td align="center"><font color="blue">市场商家页广告</font></td>
                        <td align="center">
                          <%
		                                        ...
		                                        if (code == 116) {
		                                            ...
		                                            return false;
			                                			...
			                                			function order(posX, startTime,totalFee,discount,hash){
			                                				window.open("${ctx}/promotion/toMarketBusiness?posX="+posX+"&startTime="+startTime+"&totalFee="+totalFee+"&discount="+discount+"&hash="+hash,"订购广告","width=800, height=400");
		                                				}	    
		                                			</script>
                              <%--
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/promotion/sulist.js"></script>
</body>
</html>