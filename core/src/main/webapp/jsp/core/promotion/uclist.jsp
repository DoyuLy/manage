...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/promotion/uclist.css" />
...
<body>
  ...
  <div id="sitebody">
    <div id="mbox_left">
      <ul id="ml_menu">
        ...
        <li class="mlm_select"><a href="/promotion/uclist">用户中心广告</a></li>
      ...
      <c:choose>
        ...
        <c:otherwise>
          <table class="table" style="z-index: 1;">
            <tr>
              <th colspan="2" style="height: 50px; background: #0088E4; color: white;">Go2.CN用户中心广告</th>
            </tr>
            <tr>
              <th width="80">位置说明</th>
              <td style="text-align: left; line-height: 150%; padding: 5px 20px 5px 20px; font-size: 12px;">
                <p style="text-indent: 24px;">用户中心广告，位于网站卖家和代发用户登录后的首页，每次GO2.CN上的卖家登录后即可查看到。据2014.2.27-2014.3.5平均访问数据，该页面每天有超过7000次的曝光率。该广告位同期开放
                  30 个产品位，随机展示。</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th width="80">订购价格</th>
              <td style="text-align: left; line-height: 150%; padding: 5px 20px 5px 20px; font-size: 12px;"><span style="color: red">300元/7天</span>
              </td>
            </tr>
            <tr>
              <th width="80">订购规则</th>
              <td style="text-align: left; line-height: 150%; padding: 5px 20px 5px 20px; font-size: 12px;">
                <ol style='margin: 0px; padding: 0px 0px 0px 20px;'>
                  ...
                  <li>同一厂商每周最多只能订购一个用户中心广告位或搜索结果广告位</li>
                ...
                <div style="margin: 0px; height: 120px; padding-left:259px; font-size: 16px; font-family: 微软雅黑;">
                  ...
                  <script>
									...
									function countdownComplete() {
										window.location.href = "/promotion/uclist";
									}
								</script>
                </div>
              </div>
 ...
 %> <fmt:formatDate var="endTimeStr" value="${endTimeValue}" pattern="yyyy-MM-dd" /> ${endTimeStr}</td>
                        ...
                        <td align="center"><font color="blue">用户中心广告位</font></td>
                        <td align="center">
                          <%
		                                        ...
		                                        if (code == 116) {
		                                            ...
		                                            return false;
			                                			...
			                                			function order(posX, startTime,totalFee,discount,hash){
			                                				window.open("${ctx}/promotion/toOrderUc?posX="+posX+"&startTime="+startTime+"&totalFee="+totalFee+"&discount="+discount+"&hash="+hash,"订购广告","width=800, height=400");
		                                				}	    
		                                			</script>
                              <%--
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/promotion/uclist.js"></script>
</body>
</html>