...
<body>
  ...
  <div class="content">
    ...
    <div class="right-con">
      <form:form modelAttribute="userForm" action="/userCenter/seller/password" method="POST" commandName="userForm">
        <p>
        ...
        <p>
          <label>新密码<em>如果需要修改密码，请填写此项，如果不需要就不用填写了。</em></label>
          <span><form:input path="password" /></span>
          <span class="stau3">不能为空,6-16位之间</span>
        </p>
        
        <p>
          <label>确认新密码<em>如果需要修改密码，请确认本次输入和刚刚输入的新密码相同。</em></label>
