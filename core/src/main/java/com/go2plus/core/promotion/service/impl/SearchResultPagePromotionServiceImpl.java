...
@Service
public class SearchResultPagePromotionServiceImpl implements SearchResultPagePromotionService {
  ...
  public TreeMap<String, Promotion> getOrderedSRsBy(Date startTime) {
    ...
    List<Promotion> list = promotionDao.getOrderedSRsBy(startTime);
    if (list != null) {
