package com.mtwu.builder.core.impl;
...
import com.mtwu.builder.util.CommonUtil;
import com.mtwu.builder.util.VelocityUtil;
import com.mtwu.builder.util.XmlUtil;
/**
 * @Description:  
 * @User: mtwu
...
public class Builder implements IBuilder {
	...
	public void buildeJavaBean(){
		try {
			...
			agt.put("list", list);
			agt.put("entityPackageName", maker.getEntityPackageName());
			
			String path = System.getProperty("user.dir")+"/"+maker.getCreatePath()+"/"+maker.getEntityPackageName()+"/";
	...
	public void buildeQueryJavaBean(){
		try {
			...
			String path = System.getProperty("user.dir")+"/"+maker.getCreatePath()+"/"+maker.getEntityPackageName()+"/model/";
	...
	public void buildeRepository() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/IbatisDao(interface).vm");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("entityPackageName", maker.getEntityPackageName());
			agt.put("author", maker.getAuthor());
			agt.put("daoPackageName", maker.getDaoPackageName());
			
			String path = System.getProperty("user.dir")+"/"+maker.getCreatePath()+"/"+maker.getDaoPackageName()+"/";
	        String fileName = maker.getEntityName() + "Dao.java";
	        agt.toFile(path, fileName);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void buildeDAOImpl() {
		try {
			...
			String path = System.getProperty("user.dir")+"/"+maker.getCreatePath()+"/"+maker.getDaoPackageName()+"/impl/";
	...
	public void buildeIBatis() {
		try {
			...
			String path = System.getProperty("user.dir")+"/"+maker.getCreatePath()+"/"+maker.getEntityPackageName()+"/mapper/";
	...
	public void buildeController() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/Controller(mybatis).vm");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("list", list);
      ...
      agt.put("daoPackageName", maker.getDaoPackageName());
			...
			String path = System.getProperty("user.dir")+"/"+maker.getCreatePath()+"/controller/";
	        String fileName = maker.getEntityName() + "Controller.java";
	        agt.toFile(path,fileName);
		} catch (Exception e) {
			e.printStackTrace();
		}
